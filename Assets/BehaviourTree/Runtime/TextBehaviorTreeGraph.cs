...
namespace BananaParty.BehaviorTree
{
    public class TextBehaviorTreeGraph : ITreeGraph<IReadOnlyBehaviorNode>
    {
        ...
        private readonly Dictionary<BehaviorNodeStatus, string> _statusToString = new Dictionary<BehaviorNodeStatus, string>()
        {
        ...
        private readonly Stack<int> _childrenToDraw = new Stack<int>();
